    ...
    Object.keys(mergedStyles).forEach(key => {
      ...
      if (Array.isArray(value)) {
        ...
        if (isTransform(key)) {
          ...
          if (sequence.length) {
            const transform = {};
            transform[key] = (0, _reactNativeReanimated.withSequence)(sequence[0], ...sequence.slice(1)); // @ts-ignore
          ...
          if (sequence.length) {
            final[key] = (0, _reactNativeReanimated.withSequence)(sequence[0], ...sequence.slice(1));
          }
        }
