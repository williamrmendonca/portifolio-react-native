...
const ElementTransitionsDetail = ({ navigation, route }) => {
...
ElementTransitionsDetail.sharedElements = route => {
  const { item } = route.params;
  return [
    {
...
export default ElementTransitionsDetail;
