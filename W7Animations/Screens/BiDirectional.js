            ...
            <TouchableOpacity
              onPress={() => {
                ...
                sectionRef?.current.scrollToLocation({
                  ...
                  itemIndex: 0,
                  animated: true,
                  viewOffset: 0,  // -130 fix top
                  viewPosition: 0.2,
                });
              }}>
              <MotiView
                animate={{
                  backgroundColor: fIndex === index ? '#FCD259ff' : '#f9c2ff00',
                  borderColor: fIndex === index ? '#f9c2ff00' : '#FCD259ff',
                ...
                <Text style={
                        [
                            styles.tabsText, 
                            {color: fIndex === index ? '#000' : '#FCD259ff' }
                        ]
                    }>{item.title}</Text>
              </MotiView>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  container: {
    ...
    backgroundColor: '#36303F'
  },
  item: {
    backgroundColor: '#FCD259ff',
    padding: 10,
    marginVertical: 8,
  },
  header: {
